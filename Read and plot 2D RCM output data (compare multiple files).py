...
for directory in directories:
    ...
    for fn in a:
        ...
        # plt.figure(1)
        # plt.semilogy(tzmcols,pzmcols,ls=linestyles[i2],label='{:3.0f} bar'.format(pico2[0]))
        ...
        # plt.figure(1)
        # plt.semilogy(totdflumcols-totuflumcols,pzmcols,ls=linestyles[i2],label='{:3.0f} bar'.format(pico2[0]))
        # # plt.ylim(pzmcols[0]*1.1,1)
        # plt.ylabel('Pressure (hPa)')
        ...
        # plt.subplot(121)
        # plt.title('tzm')
        # plt.semilogy(tzmcols,pzmcols,'-',label=str(fn),ls=linestyles[i2])
        ...
        # plt.subplot(122)
        # plt.title('totuflum')
        # plt.semilogy(totdflumcols-totuflumcols,pzmcols,'-',label=str(fn),ls=linestyles[i2])
