MODULE MYSUBS
    ...
    subroutine calcswhtr
        ...
        do i=2,nlayersm
            ...
            ! htro3_lh(i) = htro3_lh(i) * 3.14 * pzm(0) / 1000. ! no factor of pi; lacis uses pi * F0 to mean the incident flux and I got confused. leaving for reference
