...
!    real,dimension(maxextraclds) :: extra_cld_taus,extra_cld_alts,extra_cld_fracs,extra_cld_latcols,extra_cld_cldcols
    ...
    solar_constants,zencols,boxnettotflux_prev
    ...
    character(len=1024) :: qfn,o3fn,ccfn,clwcfn,ciwcfn,ccfracsfn,cctausfn,ccaltsfn !filenames for input distbns
    ...
    integer :: lapse_type,h2o_sb,h2o_for,h2o_source
    real :: ur_mt
